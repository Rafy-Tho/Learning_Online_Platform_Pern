...
export default function CourseDetailPage() {
  ...
  const { updateObjective, isUpdating: isUpdatingObjective } =
    useUpdateObjective();
  const { deleteObjective, isDeleting: isDeletingObjective } =
    useDeleteObjective();
  const { createObjective, isCreating: isCreatingObjective } =
    useCreateObjective();
  ...
  const addObjective = async () => {
    ...
    try {
      ...
      toast({
        title: 'Success',
        description: 'Objective create successfully',
      });
      setObjectives((os) => [...os, response?.data]);
    } catch (error) {
      toast({
        title: 'Error',
